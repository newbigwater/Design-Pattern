...
using _01.Creational_Pattern.AbstractFactory.Version_01._03._Concrete.MySQL;
...
{
    public class AbstractFactory_DAO_MySQL_Factory : AbstractFactory_DAO_Factory
    {
        #region ▶  Event Handle             ◀
        ...
        {
            return new AbstractFactory_DAO_MySQL_UserInfo();
        }

        public override AbstractFactory_DAO_Product CreateProductDao()
        {
            return new AbstractFactory_DAO_MySQL_Product();
        }

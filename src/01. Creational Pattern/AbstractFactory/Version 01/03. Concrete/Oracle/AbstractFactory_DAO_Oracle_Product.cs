...
namespace _01.Creational_Pattern.AbstractFactory.Version_01._03._Concrete.Oracle
{
    public class AbstractFactory_DAO_Oracle_Product : AbstractFactory_DAO_Product
    {
        ...
        {
            var value = $"insert into ORCLE DB productId = {product.ProductId}";
        ...
        {
            var value = $"update into ORCLE DB productId = {product.ProductId}";
            Console.WriteLine(value);
        ...
        {
            var value = $"delete from ORCLE DB productId = {prodcut.ProductId}";
            Console.WriteLine(value);
